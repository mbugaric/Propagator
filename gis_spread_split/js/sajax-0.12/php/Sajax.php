...
if (!isset($SAJAX_INCLUDED)) {
	...
	//Dodano radi situacije sa VPN-om, ostatak u postavke_dir_gis.php
	$server=$_SERVER['HTTP_HOST'];	 
	
	//Eh, ovo je hardcodirano, pa sad ... treba pripazit
	if($server != $ip_servera_local)
	{
		$sajax_remote_uri=$SajaxAppendix.$sajax_remote_uri;
		$sajax_remote_uri="gis.php";
